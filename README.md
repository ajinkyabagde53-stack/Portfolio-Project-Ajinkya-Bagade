...
17. Git commands failed — terminal was in wrong directory (C:\Users\Ajinkya instead of repo folder)
18. Cloned the repository properly using git clone
19. Navigated into the correct repo folder and re-created README.md
20. Pasted README content, saved, committed and pushed to GitHub
...
**Problem 4:** Could not find file explorer in Cursor — interface only showed AI agent panel.
...
**Solution:** Terminal was running in C:\Users\Ajinkya instead of the repo folder. Cloned the repo using git clone and navigated into the correct directory before running git commands.
...
✅ README created via PowerShell and Notepad, pushed to GitHub